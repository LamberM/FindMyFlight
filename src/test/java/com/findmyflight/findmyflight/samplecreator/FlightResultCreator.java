...
public class FlightResultCreator {
    ...
    @Transactional
    public FlightResult createSample(boolean flightWatcherSuspended, EmailNotificationReceiver emailNotificationReceiver) {
        var flightResult = FlightResult.builder()
                .result("1000")
                .flightWatcher(flightWatcherCreator.createSample(flightWatcherSuspended, LocalDate.of(2025, 1, 1), emailNotificationReceiver))
                .build();
